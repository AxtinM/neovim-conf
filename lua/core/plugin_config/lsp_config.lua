...
local on_attach = function(client, bufnr)
	...
	buf_set_keymap("n", "<C-k>", ":lua vim.lsp.buf.hover()<CR>", opts)
	...
	buf_set_keymap("n", "cr", ":lua vim.lsp.buf.references()<CR>", opts) --> lists all the references to the symbl under the cursor in the quickfix window
